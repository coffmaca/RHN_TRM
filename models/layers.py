...
class SwiGLU(nn.Module):
    def __init__(self,
        ...
        self.gate_up_proj = CastedLinear(in_dim, inter * 2, bias=False, use_spectral_norm=use_spectral_norm)
        self.down_proj    = CastedLinear(inter, out_dim, bias=False, use_spectral_norm=use_spectral_norm)
